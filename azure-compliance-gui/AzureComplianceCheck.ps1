...
$loginButton.Location = New-Object System.Drawing.Point(10, 190)
...
$scanButton.Location = New-Object System.Drawing.Point(140, 190)
...
$jobsButton.Location = New-Object System.Drawing.Point(270, 190)
...
$clearJobsButton.Location = New-Object System.Drawing.Point(140, 230)
...
$jobListView.Location = New-Object System.Drawing.Point(10, 270)
...
$outputPane.Location = New-Object System.Drawing.Point(10, 460)
$outputPane.Size = New-Object System.Drawing.Size(380, 50)
...
$userLabel.Location = New-Object System.Drawing.Point(10, 520)
$userLabel.Size = New-Object System.Drawing.Size(380, 20)
$form.Controls.Add($userLabel)

$tenantLabel = New-Object System.Windows.Forms.Label
$tenantLabel.Location = New-Object System.Drawing.Point(10, 540)
...
$subscriptionLabel.Location = New-Object System.Drawing.Point(10, 560)
...
$scanButton.Add_Click({
    ...
    if ($selectedSubscription) {
        ...
        try {
            ...
            $outputPane.AppendText("Running Start-AzPolicyComplianceScan`n")
